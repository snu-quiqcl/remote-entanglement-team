...
class AD9912_w_VVA(default_parameters):
    ...
    def openDevice(self):
        if self._connected:
            ...
            for board in range(2):
                self._setActualCurrent(board, 1, 1, 0)
    ...
    @requires_connection
    def setVoltage(self, board, ch1, ch2, voltage):
        """
        This function changes the output voltage of the DAC, which controls the attenuation using VVA.
        Note that the actual value is 3 times smaller because of the hardware configuration.
    ...
    @requires_connection
    def power_down(self, board, ch1, ch2):
        """
    ...
    @requires_connection
    def power_up(self, board, ch1, ch2):
        """
        ...
        self.setVoltage(board, ch1, ch2, 0)
