...
dir_name = os.path.dirname("Q:/Experiment_Scripts/Chamber_3G_SNU/PMT_align/HardwareDefinition_SNU_v4_01.py")
hd_module = os.path.basename("Q:/Experiment_Scripts/Chamber_3G_SNU/PMT_align/HardwareDefinition_SNU_v4_01.py")[:-3]
...
for time_length_0 in range(0, 100000, 5000):
	data_dict_1 = dict()
	...
	s.set_output_port(hd.external_control_port, [(hd.Microwave_12_6GHz_out, 0), (hd.EOM_14_7GHz_out, 1), (hd.EOM_2_1GHz_out, 1), (hd.AOM_200_205MHz_out, 0), (hd.AOM_on_off_out, 0), (hd.external_trigger_out, 0), ])
	s.wait_n_clocks(65532)
	s.wait_n_clocks(34460)
	
	if time_length_0 == 0:
		s.init = \
		s.set_output_port(hd.external_control_port, [(hd.EOM_14_7GHz_out, 0), (hd.EOM_2_1GHz_out, 0), (hd.AOM_200_205MHz_out, 1), ])
	else:
		s.init = \
		s.set_output_port(hd.external_control_port, [(hd.EOM_14_7GHz_out, 0), (hd.EOM_2_1GHz_out, 0), ])
		...
		s.set_output_port(hd.external_control_port, [(hd.AOM_200_205MHz_out, 1), ])
	s.nop()
	...
	s.set_output_port(hd.external_control_port, [(hd.AOM_200_205MHz_out, 0), ])
...
with open("SequencerData/sequencerGUI_data_200831_180437.yaml", 'w') as f:
