...
for time_length_0 in range(0, 2500000, 50000):
	...
	s.wait_n_clocks(6)
	if time_length_0 == 0:
		s.set_output_port(hd.external_control_port, [(hd.EOM_2_1GHz_out, 0), (hd.AOM_200_205MHz_out, 1), (hd.AOM_on_off_out, 0), ])
		s.wait_n_clocks(9996)
	else:
		...
		s.set_output_port(hd.external_control_port, [(hd.Microwave_12_6GHz_out, 0), (hd.EOM_2_1GHz_out, 0), (hd.AOM_200_205MHz_out, 1), (hd.AOM_on_off_out, 0), ])
		s.wait_n_clocks(9996)
...
with open("SequencerData/sequencerGUI_data_200831_173231.yaml", 'w') as f:
