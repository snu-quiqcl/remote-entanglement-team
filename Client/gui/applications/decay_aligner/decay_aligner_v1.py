...
uifile = dirname + '/decay_aligner_v1.ui'
widgetdir = dirname + '/widgets/'

Ui_Form, QtBaseClass = uic.loadUiType(uifile)
version = "1.0"

from decay_aligner_theme import decay_aligner_theme_base
        
class DecayAlignerGUI(QtWidgets.QMainWindow, Ui_Form, decay_aligner_theme_base):
    ...
    def _initUi(self):
        ...
        self._addTabWidget(self.scanner, "Decay Scanner")
        self._addTabWidget(self.count_viewer, "Decay Count Viewer")
...
if __name__ == "__main__":
    device_dict = {}
    device_dict["motors"]={"motor_controller_v3":"MotorController"}
    device_dict["sequencer"]={"Sequencer_GUI":"Sequencer_GUI"}
    pmt = DecayAlginerGUI(device_dict = device_dict)#device_dict=None, parent=None, theme="black", app_name=""
    pmt.show()
